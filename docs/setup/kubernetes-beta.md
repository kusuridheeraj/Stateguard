...
- Kubernetes delete guard via `stateguard kube guard-delete -f examples/kubernetes-beta/manifests.yaml`
- example manifests in `examples/kubernetes-beta/manifests.yaml`
- beta support now includes delete-guard evaluation, not full admission enforcement yet
