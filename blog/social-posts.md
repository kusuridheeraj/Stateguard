...
We are building an open-source tool called Stateguard to prevent accidental state loss during destructive Docker Compose and Kubernetes operations.

The focus is not just “backups exist somewhere,” but whether protection is recent, visible, and actually tied to the risky action someone is about to run.

The repo is live and being built in public.
